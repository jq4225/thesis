...
anxiety_bus <- felm(I(log(anxiety + 1 )) ~  
                 factor(busclose_first_counter) * year_indicator + 
                factor(busopen_most_pop_counter) * year_indicator + 
              ...
              weights = na.omit(searches_norm3_v21_5$pop),
                  data = searches_norm3_v21_5 %>% filter(is.na(pop) == FALSE))
