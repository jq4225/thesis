...
```{r}
# Let's do some pre-trends graphing

part1 <- searches_norm3_v14 %>% 
  mutate(year_indicator = as.character(year_indicator)) %>% 
  group_by(week, year_indicator) %>%
  summarize(all_mean = mean(c(depression, crying, lonely, sad,
                               stress, suicide, tired))) %>% 
  ungroup() %>% 
  group_by(year_indicator) %>% 
  arrange(week) %>% 
  mutate(roll_mean = rollmean(all_mean, k = 3, fill = "extend")) %>% 
  ggplot(mapping = aes(x = week, y = roll_mean)) + 
    geom_line(aes(color = year_indicator)) + 
    labs(x = "Week of Year", y = "SVI", title = "Average Depression-related SVI") +
    scale_color_discrete(name = "Year", labels = c("2016-2019", "2020")) +
    scale_x_continuous(breaks = seq(from = 0, to = 53, by = 10)) + 
    geom_vline(xintercept = 13, linetype = "dashed") + 
    theme_classic(base_size = 14)

part2 <- searches_norm3_v14 %>% 
  mutate(year_indicator = as.character(year_indicator)) %>% 
  group_by(week, year_indicator) %>%
  summarize(all_mean = mean(c(anxiety, nervous, panic,
                               stress, worry))) %>% 
  ungroup() %>% 
  group_by(year_indicator) %>% 
  arrange(week) %>% 
  ...
  ggplot(mapping = aes(x = week, y = roll_mean)) + 
    geom_line(aes(color = year_indicator)) + 
    labs(x = "Week of Year", y = "SVI", title = "Average Anxiety SVI") +
    scale_color_discrete(name = "Year", labels = c("2016-2019", "2020")) +
    scale_x_continuous(breaks = seq(from = 0, to = 53, by = 10)) + 
    geom_vline(xintercept = 13, linetype = "dashed") + 
    theme_classic(base_size = 14)

part3 <- searches_norm3_v14 %>% 
  mutate(year_indicator = as.character(year_indicator)) %>% 
  group_by(week, year_indicator) %>%
  summarize(all_mean = mean(c(exercise, therapy, yoga))) %>% 
  ungroup() %>% 
  group_by(year_indicator) %>% 
  arrange(week) %>% 
  mutate(roll_mean = rollmean(all_mean, k = 3, fill = "extend")) %>% 
  ggplot(mapping = aes(x = week, y = roll_mean)) + 
    geom_line(aes(color = year_indicator)) + 
    labs(x = "Week of Year", y = "SVI", title = "Average Coping SVI") +
    scale_color_discrete(name = "Year", labels = c("2016-2019", "2020")) +
    scale_x_continuous(breaks = seq(from = 0, to = 53, by = 10)) + 
    geom_vline(xintercept = 13, linetype = "dashed") + 
    theme_classic(base_size = 14)

part4 <- searches_norm3_v14 %>% 
  mutate(year_indicator = as.character(year_indicator)) %>% 
  group_by(week, year_indicator) %>%
  summarize(all_mean = mean(c(alcohol, alcoholism, cannabis, cigarette,
                              e_cig, substance_abuse, smoking))) %>% 
  ungroup() %>% 
  group_by(year_indicator) %>% 
  arrange(week) %>% 
  mutate(roll_mean = rollmean(all_mean, k = 3, fill = "extend")) %>% 
  ggplot(mapping = aes(x = week, y = roll_mean)) + 
    geom_line(aes(color = year_indicator)) + 
    labs(x = "Week of Year", y = "SVI", title = "Average Substance Use SVI") +
    scale_color_discrete(name = "Year", labels = c("2016-2019", "2020")) +
    scale_x_continuous(breaks = seq(from = 0, to = 53, by = 10)) + 
    geom_vline(xintercept = 13, linetype = "dashed") + 
    theme_classic(base_size = 14)

combined <- ggarrange(plotlist = list(part1, part2, part3, part4))
```
...
depression_sip<- felm(I(log(0.485 * crying + 0.782 * depression + 
             ...
             data = searches_norm3_v22_5 %>% drop_na(pop),
...
substance_sip <- felm(log(0.144*alcohol + 0.833*cannabis + 0.451*cigarette + 
...
substance_misuse_sip <- felm(log(0.308 * addiction + 0.390 * alcoholism + 0.104 * rehab + 
...
dwplot(list(depression_sip, anxiety_sip),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
       vars_order = c("sip_first:year_indicator", "year_indicator:no_sip_most_pop"),
       model_order = c("Model 1", "Model 2"),
       dodge_size = 0.9)%>% 
       relabel_predictors(c("sip_first:year_indicator" = "SIP start",
                          "year_indicator:no_sip_most_pop" = "SIP end")) + 
      theme_classic(base_size = 14) + 
      scale_color_discrete(name = "Outcome", labels = c(
                                                        "Anxiety", "Depression")) +
      scale_x_continuous(labels = scales::percent) + 
      labs(x = "Effect size (approx. % change)") + 
      theme(legend.position = "top")

dwplot(list(therapy_sip, yoga_sip),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
       vars_order = c("sip_first:year_indicator", "year_indicator:no_sip_most_pop",
                      "year_indicator:online_only", "year_indicator:hybrid"),
       model_order = c("Model 1", "Model 2"),
       dodge_size = 0.9)%>% 
       relabel_predictors(c("sip_first:year_indicator" = "SIP start",
                          "year_indicator:no_sip_most_pop" = "SIP end",
                          "year_indicator:online_only" = "Online school reopening",
                          "year_indicator:hybrid" = "Hybrid school reopening")) + 
      theme_classic(base_size = 14) + 
      scale_color_discrete(name = "Outcome", labels = c(
                                                        "Yoga", "Therapy")) +
      scale_x_continuous(labels = scales::percent) + 
...
dwplot(list(substance_sip, substance_misuse_sip),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
...
```{r}
dwplot(list(depression_bus, anxiety_bus),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
       vars_order = c("busclose_first:year_indicator", "year_indicator:busopen_most_pop"),
       model_order = c("Model 1", "Model 2")) %>% 
       relabel_predictors(c("busclose_first:year_indicator" = "Closure start",
                          "year_indicator:busopen_most_pop" = "Closure end")) + 
      theme_classic(base_size = 14) + 
      scale_color_discrete(name = "Outcome", labels = c("Anxiety", "Depression")) +
      scale_x_continuous(labels = scales::percent) + 
      labs(x = "Effect size (approx. % change)") + 
      theme(legend.position = "top")
```
...
dwplot(list(therapy_bus, yoga_bus),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
       ...
       relabel_predictors(c("busclose_first:year_indicator" = "Closure start",
                          ...
                          "year_indicator:hybrid" = "Hybrid school reopening")) + 
      theme_classic(base_size = 14) + 
      scale_color_discrete(name = "Outcome", labels = c("Yoga", "Therapy")) +
      scale_x_continuous(labels = scales::percent) + 
      labs(x = "Effect size (approx. % change)") + 
      theme(legend.position = "top")
```
...
substance_busclose <- felm(log(0.144*alcohol + 0.833*cannabis + 0.451*cigarette + 
                            0.172*e_cig + 0.228*smoking + 1) ~ 
                                  busclose_first*year_indicator + 
                                     busopen_most_pop*year_indicator + 
                        online_only*year_indicator + 
...
substance_misuse_busclose <- felm(log(0.308 * addiction + 0.390 * alcoholism + 0.104 * rehab + 
                             0.861 * substance_abuse + 1) ~ 
                                  busclose_first * year_indicator + 
                                     busopen_most_pop * year_indicator + 
                        online_only * year_indicator + 
...
dwplot(list(substance_busclose, substance_misuse_busclose),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
       ...
       relabel_predictors(c("busclose_first:year_indicator" = "Closure start",
                          ...
                          "year_indicator:hybrid" = "Hybrid school reopening")) + 
      theme_classic(base_size = 14) + 
      scale_color_discrete(name = "Outcome", labels = c("Substance Misuse", "Substance Use")) +
      scale_x_continuous(labels = scales::percent) + 
      labs(x = "Effect size (approx. % change)") + 
      theme(legend.position = "top")
...
depression_2 <- felm(log(hps_depression) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_2 <- felm(log(hps_anxiety) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(depression_1, depression_2, anxiety_1, anxiety_2),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60",
       ),
       vars_order = c("c1_post", "c1_future",
                      "factor(c1_school_closing)1", "factor(c1_school_closing)2",
                      "factor(c1_school_closing)3"),
       model_order = c("Model 1", "Model 3", "Model 2", "Model 4"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c1_post" = "Closure end",
                         "c1_future" = "Subsequent closure start",
                         "factor(c1_school_closing)1" = "Closure level 1",
                         "factor(c1_school_closing)2" = "Closure level 2",
                         "factor(c1_school_closing)3" = "Closure level 3")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Model", labels = c("Anxiety (strictness)",
                                                      "Depression (strictness)",
                                                      "Anxiety (start/end)", 
                                                      "Depression (start/end)")) +
      scale_x_continuous(labels = scales::percent) + 
      labs(x = "Effect size (approx. % change)") + 
      theme(legend.position = "top") + 
...
depression_1 <- felm(log(hps_depression) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_1 <- felm(log(hps_anxiety) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(depression_1, depression_2, anxiety_1, anxiety_2),
       ...
       vars_order = c("c2_post", "c2_future",
                      "factor(c2_workplace_closing)1", "factor(c2_workplace_closing)2",
                      "factor(c2_workplace_closing)3"),
       model_order = c("Model 1", "Model 3", "Model 2", "Model 4"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c2_post" = "Closure end",
                         "c2_future" = "Subsequent closure start",
                         "factor(c2_workplace_closing)1" = "Closure level 1",
                         "factor(c2_workplace_closing)2" = "Closure level 2",
                         "factor(c2_workplace_closing)3" = "Closure level 3")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Model", labels = c("Anxiety (strictness)",
                                                      "Depression (strictness)",
                                                      "Anxiety (start/end)", 
...
depression_1 <- felm(log(hps_depression) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_2 <- felm(log(hps_depression) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_1 <- felm(log(hps_anxiety) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_2 <- felm(log(hps_anxiety) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(depression_1, depression_2, anxiety_1, anxiety_2),
       ...
       vars_order = c("c6_post", "c6_future",
                      "factor(c6_stay_at_home_requirements)1", "factor(c6_stay_at_home_requirements)2"),
       model_order = c("Model 1", "Model 3", "Model 2", "Model 4"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c6_post" = "Order end",
                         "c6_future" = "Subsequent order start",
                         "factor(c6_stay_at_home_requirements)1" = "Order level 1",
                         "factor(c6_stay_at_home_requirements)2" = "Order level 2")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Model", labels = c("Anxiety (strictness",
                                                      "Depression (strictness)",
                                                      "Anxiety (start/end)", 
...
therapy_2 <- felm(log(medication) ~ c1_post + c1_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_3 <- felm(log(no_counseling) ~ c1_post + c1_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_4 <- felm(log(counseling) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_5 <- felm(log(medication) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_6 <- felm(log(no_counseling) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(therapy_1, therapy_2, therapy_3),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
    ...
    relabel_predictors(c("c1_post" = "Closure end",
                         ...
                         "factor(c1_school_closing)3" = "Closure level 3")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Model", labels = c("No counseling (strictness)",
                                                      "Medication (strictness)",
                                                      "Counseling (strictness)", 
                                                      "No counseling (start/end)",
                                                    "Medication (start/end)",
                                                    "Counseling (start/end)")) +
      scale_x_continuous(labels = scales::percent) + 
      labs(x = "Effect size (approx. % change)") + 
      theme(legend.position = "top") + 
      guides(color=guide_legend(nrow=2, byrow=TRUE))

dwplot(list(therapy_1, therapy_2, therapy_3, therapy_4, therapy_5, therapy_6),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
...
therapy_1 <- felm(log(counseling) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_2 <- felm(log(medication) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_3 <- felm(log(no_counseling) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_4 <- felm(log(counseling) ~ factor(c2_workplace_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_6 <- felm(log(no_counseling) ~ factor(c2_workplace_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_1 <- felm(log(counseling) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_2 <- felm(log(medication) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_3 <- felm(log(no_counseling) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_4 <- felm(log(counseling) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_5 <- felm(log(medication) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
therapy_6 <- felm(log(no_counseling) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(therapy_1, therapy_2, therapy_3, therapy_4, therapy_5, therapy_6),
       ...
       model_order = c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c6_post" = "Closure end",
                         "c6_future" = "Subsequent closure start",
                         "factor(c6_stay_at_home_requirements)1" = "Order level 1",
                         "factor(c6_stay_at_home_requirements)2" = "Order level 2")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Model", labels = c("No counseling (strictness)",
...
```{r}
# Workplace closures, HPS, by Race


depression_3 <- felm(log(depression_black + 1) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_4 <- felm(log(depression_black + 1) ~ factor(c2_workplace_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_5 <- felm(log(depression_white + 1) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_6 <- felm(log(depression_white + 1) ~ factor(c2_workplace_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(depression_3, depression_4, depression_5, depression_6),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60",
       ),
       vars_order = c("c2_post", "c2_future",
                      "factor(c2_workplace_closing)1", 
                      "factor(c2_workplace_closing)2",
                      "factor(c2_workplace_closing)3"),
       model_order = c("Model 1", "Model 3", "Model 2", "Model 4"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c2_post" = "Closure end",
...
```{r}
anxiety_3 <- felm(log(anxiety_agg_black + 1) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_4 <- felm(log(anxiety_agg_black + 1) ~ factor(c2_workplace_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_5 <- felm(log(anxiety_agg_white + 1) ~ c2_post + c2_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_6 <- felm(log(anxiety_agg_white + 1) ~ factor(c2_workplace_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(anxiety_3, anxiety_4, anxiety_5, anxiety_6),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60",
       ),
...
```{r}
# School closures
depression_3 <- felm(log(depression_black + 1) ~ c1_post + c1_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_4 <- felm(log(depression_black + 1) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_5 <- felm(log(depression_white + 1) ~ c1_post + c1_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_6 <- felm(log(depression_white + 1) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(depression_3, depression_4, depression_5, depression_6),
       ...
       vars_order = c("c1_post", "c1_future",
                      "factor(c1_school_closing)1", 
                      "factor(c1_school_closing)2",
                      "factor(c1_school_closing)3"),
       model_order = c("Model 1", "Model 3", "Model 2", "Model 4"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c1_post" = "Closure end",
...
```{r}
anxiety_3 <- felm(log(anxiety_agg_black + 1) ~ c1_post + c1_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_4 <- felm(log(anxiety_agg_black + 1) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_5 <- felm(log(anxiety_agg_white + 1) ~ c1_post + c1_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_6 <- felm(log(anxiety_agg_white + 1) ~ factor(c1_school_closing) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
```{r}
# School closures
depression_3 <- felm(log(depression_black + 1) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_4 <- felm(log(depression_black + 1) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_5 <- felm(log(depression_white + 1) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
depression_6 <- felm(log(depression_white + 1) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(depression_3, depression_4, depression_5, depression_6),
       ...
       vars_order = c("c6_post", "c6_future",
                      "factor(c6_stay_at_home_requirements)1", 
                      "factor(c6_stay_at_home_requirements)2"),
       model_order = c("Model 1", "Model 3", "Model 2", "Model 4"),
       dodge_size = 1) %>% 
    relabel_predictors(c("c6_post" = "Closure end",
                         "c6_future" = "Subsequent closure start",
...
```{r}
anxiety_3 <- felm(log(anxiety_agg_black + 1) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_4 <- felm(log(anxiety_agg_black + 1) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_5 <- felm(log(anxiety_agg_white + 1) ~ c6_post + c6_future +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
anxiety_6 <- felm(log(anxiety_agg_white + 1) ~ factor(c6_stay_at_home_requirements) +
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
dwplot(list(anxiety_3, anxiety_4, anxiety_5, anxiety_6),
    ...
    relabel_predictors(c("c6_post" = "Closure end",
                         "c6_future" = "Subsequent closure start",
                         "factor(c6_stay_at_home_requirements)1" = "Closure level 1",
                         "factor(c6_stay_at_home_requirements)2" = "Closure level 2")) +
    theme_classic(base_size = 14) +
...
dwplot(list(depression_3, depression_4, anxiety_3, anxiety_4),
       dot_args = list(size = 3),
       # vline = geom_vline(
       #     xintercept = 0,
       #     colour = "grey60",
       # ),
       vars_order = c("log(hps_depression)", "log(hps_anxiety)"),
       model_order = c("Model 1", "Model 2", "Model 3", "Model 4"),
       dodge_size = 0.5) %>% 
    relabel_predictors(c("log(hps_depression)" = "Depression (HPS)",
                         "log(hps_anxiety)" = "Anxiety (HPS)")) +
    theme_classic(base_size = 14) +
...
dwplot(list(therapy_2, therapy_4, therapy_6),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60",
       ),
       vars_order = c("log(therapy_norm + 1)"),
       model_order = c("Model 1", "Model 2", "Model 3"),
       dodge_size = 0.5) %>% 
    relabel_predictors(c("log(therapy_norm + 1)" = "Therapy SVI")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Outcome", labels = c(
                                                    "Medication",
                                                      "No counseling",
...
dwplot(list(alc_3, alc_7),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60",
       ),
       vars_order = c("log(all_alc)"),
       model_order = c("Model 1", "Model 2"),
       dodge_size = 0.5) %>% 
    relabel_predictors(c("log(all_alc)" = "Gallons per capita")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Outcome", labels = c(
                                                    "Alcoholism SVI",
                                                      "Alcohol SVI"
...
dwplot(list(cig_3, cig_7),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60",
       ),
       vars_order = c("log(packs_per_capita)"),
       model_order = c("Model 1", "Model 2"),
       dodge_size = 0.5) %>% 
    relabel_predictors(c(
                         "log(packs_per_capita)" = "Imputed packs per capita")) +
    theme_classic(base_size = 14) +
    scale_color_discrete(name = "Outcome", labels = c("Smoking index SVI",
                                                      "Cigarettes SVI"
                                                      )) +
      # scale_x_continuous(labels = scales::percent) + 
      # labs(x = "Effect size (approx. % change)") + 
