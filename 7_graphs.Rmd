...
dwplot(list(depression_sip, anxiety_sip, therapy_sip),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
      ...
      theme_classic() + 
      scale_color_discrete(name = "Outcome", labels = c("Therapy", "Anxiety", "Depression")) +
...
```{r}
dwplot(list(depression_bus, anxiety_bus, therapy_bus),
       vline = geom_vline(
           xintercept = 0,
           colour = "grey60"
       ),
