...
#depression_1 <- felm(log(hps_depression) ~ state|0|0|state, data = hps_all_v11)

depression_1 <- felm(log(depression_norm) ~ log(hps_depression)|0|0|state, data = hps_all_v11)
...
depression_3 <- felm(log(depression_norm) ~ log(hps_depression)|state|0|state, data = hps_all_v11)
...
```{r}
anxiety_1 <- felm(log(anxiety_norm) ~ log(hps_anxiety)|0|0|state, data = hps_all_v11)
...
anxiety_3 <- felm(log(anxiety_norm) ~ log(hps_anxiety)|state|0|state, data = hps_all_v11)
...
therapy_1 <- felm(log(counseling) ~ log(therapy_norm+1)|0|0|state, data = hps_all_v11)

therapy_2 <- felm(log(counseling) ~ log(therapy_norm+1)|state|0|state, data = hps_all_v11)

therapy_3 <- felm(log(no_counseling) ~ log(therapy_norm+1)|0|0|state, data = hps_all_v11)

therapy_4 <- felm(log(no_counseling) ~ log(therapy_norm+1)|state|0|state, data = hps_all_v11)

therapy_5 <- felm(log(medication) ~ log(therapy_norm+1)|0|0|state, data = hps_all_v11)

therapy_6 <- felm(log(medication) ~ log(therapy_norm+1)|state|0|state, data = hps_all_v11)

htmlreg(l = list(therapy_1, therapy_2, therapy_3, therapy_4, therapy_5, therapy_6), include.ci = FALSE, digits = 4, file = "therapy.doc")

therapy_1 <- felm(log(counseling) ~ factor(state)|0|0|state, data = hps_all_v11)

therapy_2 <- felm(log(no_counseling) ~ factor(state)|0|0|state, data = hps_all_v11)
```
