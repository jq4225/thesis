...
hps_all_v10 %>% 
  ...
  ggplot(aes(x = start_date)) + 
    geom_line(aes(y = hps_depression, color = "Household Pulse")) + 
    geom_line(aes(y = google_average/1.7, color = "Avg. related SVIs (re-scaled, normalized)")) + 
    geom_line(aes(y = depression_norm/1.3, color = "Depression SVI (re-scaled, normalized)")) + 
    labs(x = "Date", y = "% Reporting Depression") + 
    scale_color_manual(name = c("", "", ""),
                       values = c("Household Pulse" = "blue",
                                  "Avg. related SVIs (re-scaled, normalized)" = "red",
                                  "Depression SVI (re-scaled, normalized)" = "green")) + 
    theme_classic() + 
    theme(legend.position = "top")
...
hps_all_v10 %>% 
  ...
  ggplot(aes(x = start_date)) + 
    geom_line(aes(y = hps_anxiety, color = "Household Pulse")) + 
    geom_line(aes(y = google_average/1.2, color = "Avg. related SVIs (re-scaled, normalized)")) + 
    geom_line(aes(y = anxiety_norm/1.4, color = "Anxiety SVI (re-scaled, normalized)")) + 
    labs(x = "Date", y = "% Reporting Anxiety") + 
    scale_color_manual(name = c("", "", ""),
                       values = c("Household Pulse" = "blue",
                                  "Avg. related SVIs (re-scaled, normalized)" = "red",
                                  "Anxiety SVI (re-scaled, normalized)" = "green")) + 
    theme_classic() +
    theme(legend.position = "top")
...
hps_all_v8 %>%
  ...
  ggplot(aes(x = start_date)) + 
    ...
    theme_classic() + 
    labs(x = "Date", y = "% reporting depression symptoms") +
    theme(legend.position = "top")


# geom_line(aes(y = anxiety_norm/1.5, color = "Anxiety SVI (re-scaled, normalized)")) +
...
therapy_graph_2 <- hps_all_v11 %>% 
  ...
  ggplot(aes(x = start_date)) + 
    ...
    geom_line(aes(y = medication_or_counseling, color = "HPS % using medication or therapy")) + 
    geom_line(aes(y = therapy_norm/4, color = "Normalized GTrends (rescaled)")) + 
    theme_classic() +
    theme(legend.position = "top") + 
    labs(x = "Date", y = "% of Respondents") + 
      # scale_color_manual(name = c("", "", ""),
...
alcohol_v2 %>% 
  ...
  ggplot(aes(x = date)) + 
    ...
    geom_line(aes(y = alcohol_norm  * 0.007, 
                  color = "Alcohol SVI (rescaled)")) + 
    geom_line(aes(y = alcoholism_norm * 0.01, 
                  color = "Alcoholism SVI (rescaled)")) + 
    theme_classic() + 
    labs(x = "Date", y = "Gallons per Capita", title = "Alcohol") + 
    theme(legend.position = "top") + 
  scale_color_manual(name = c("", "", ""),
                       values = c("Alcohol Consumption" = "blue",
                                  "Alcohol SVI (rescaled)" = "red",
                                 "Alcoholism SVI (rescaled)" = "green"))
...
smoking_v3 %>%
  ...
  mutate(date = mdy(paste(month, "01", year, sep = "-"))) %>% 
  ggplot(aes(x = date)) + 
    geom_line(aes(y = packs_per_capita, color = "Imputed Packs Per Capita")) + 
    geom_line(aes(y = smoking * 0.1, 
                  color = "Smoking SVI (rescaled)")) + 
    geom_line(aes(y = cigarettes * 0.09, 
                  color = "Cigarettes SVI (rescaled)")) + 
    geom_line(aes(y = e_cig * 0.08, 
                  color = "E-Cigarettes SVI (rescaled)")) + 
    theme_classic() + 
    labs(x = "Date", y = "Gallons per Capita") + 
    theme(legend.position = "top") + 
  scale_color_manual(name = c("", "", ""),
                       values = c("Imputed Packs Per Capita" = "blue",
                                  "Smoking SVI (rescaled)" = "red",
                                 "Cigarettes SVI (rescaled)" = "green",
                                 "E-Cigarettes SVI (rescaled)" = "orange"))
