...
hps_all_v16_c1 <- hps_all_v16 %>% 
  drop_na(pop, c1_counter)

hps_all_v16_c2 <- hps_all_v16 %>% 
...
# business closure
depression_1 <- felm(log(hps_depression) ~ relevel(factor(c2_counter), ref = "-1")  +
               c2_future + 
               initclaims_combined + 
...
depression_1 <- felm(log(hps_depression) ~ relevel(factor(c2_counter), ref = "-1")  +
             ...
             |factor(state) + factor(year) + factor(period)|0|state,
             data = hps_all_v16,
             weights = hps_all_v16$pop)

anxiety_1 <- felm(log(hps_anxiety) ~ relevel(factor(c2_counter), ref = "-1")  +
               c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
depression_1 <- felm(log(hps_depression) ~ relevel(factor(c6_counter), ref = "-1")  +
               c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
             |factor(state) + factor(year) + factor(period)|0|state,
             data = hps_all_v15 %>% drop_na(pop, c6_counter))

anxiety_1 <- felm(log(hps_anxiety) ~ relevel(factor(c6_counter), ref = "-1")  +
               c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
total_coefs %>% 
  ...
  ggplot(aes(x = term, y = estimate, color = outcome)) + 
    geom_line() + 
      ...
      scale_y_continuous(labels = scales::percent, limits = c(-0.2, NA)) + 
      facet_wrap(~outcome) + 
      theme(panel.border = element_rect(color = "black",
                                    fill = NA,
                                    size = 0.5), 
...
total_coefs %>% 
  ...
  ggplot(aes(x = term, y = estimate, color = outcome)) + 
    geom_line() + 
      ...
      labs(x = "Weeks vs. lockdown end",
         y = "Est. % change in searches") + 
      scale_y_continuous(labels = scales::percent, limits = c(-0.1, 0.15)) + 
      xlim(-20, 20) + 
      facet_wrap(~outcome) + 
      theme(panel.border = element_rect(color = "black",
                                    fill = NA,
...
searches_norm3_v23_5 <- searches_norm3_v22_5 %>% 
...
c1_2 <- felm(log(hps_depression) ~ c1_post_2 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
             |factor(state) + factor(year) + factor(period)|0|state,
             data = hps_all_v16 %>% drop_na(pop),
             weights = (hps_all_v16 %>% drop_na(pop))$pop)

c1_1 <- felm(log(hps_depression) ~ c1_post_1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_0 <- felm(log(hps_depression) ~ c1_post + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_n1 <- felm(log(hps_depression) ~ c1_post_n1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_2 <- felm(log(hps_depression) ~ c2_post_2 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_1 <- felm(log(hps_depression) ~ c2_post_1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_0 <- felm(log(hps_depression) ~ c2_post + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_n1 <- felm(log(hps_depression) ~ c2_post_n1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_2 <- felm(log(hps_depression) ~ c6_post_2 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_1 <- felm(log(hps_depression) ~ c6_post_1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_0 <- felm(log(hps_depression) ~ c6_post + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_n1 <- felm(log(hps_depression) ~ c6_post_n1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_2 <- felm(log(hps_anxiety) ~ c1_post_2 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_1 <- felm(log(hps_anxiety) ~ c1_post_1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_0 <- felm(log(hps_anxiety) ~ c1_post + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_n1 <- felm(log(hps_anxiety) ~ c1_post_n1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_2 <- felm(log(hps_anxiety) ~ c2_post_2 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_1 <- felm(log(hps_anxiety) ~ c2_post_1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_0 <- felm(log(hps_anxiety) ~ c2_post + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_n1 <- felm(log(hps_anxiety) ~ c2_post_n1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_2 <- felm(log(hps_anxiety) ~ c6_post_2 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_1 <- felm(log(hps_anxiety) ~ c6_post_1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_0 <- felm(log(hps_anxiety) ~ c6_post + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_n1 <- felm(log(hps_anxiety) ~ c6_post_n1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
counseling_1 <- felm(log(counseling) ~ relevel(factor(c2_counter), ref = "-1")  +
               c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
medication_1 <- felm(log(medication) ~ relevel(factor(c2_counter), ref = "-1")  +
               c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
no_counseling_1 <- felm(log(no_counseling) ~ relevel(factor(c2_counter), ref = "-1")  +
               c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
counseling_1 <- felm(log(counseling) ~ relevel(factor(c1_counter), ref = "-1")  +
               c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
medication_1 <- felm(log(medication) ~ relevel(factor(c1_counter), ref = "-1")  +
               c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
no_counseling_1 <- felm(log(no_counseling) ~ relevel(factor(c1_counter), ref = "-1")  +
               c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
counseling_1 <- felm(log(counseling) ~ relevel(factor(c6_counter), ref = "-1")  +
               c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
medication_1 <- felm(log(medication) ~ relevel(factor(c6_counter), ref = "-1")  +
               c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
no_counseling_1 <- felm(log(no_counseling) ~ relevel(factor(c6_counter), ref = "-1")  +
               c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
...
c1_10 <- felm(log(counseling) ~ c1_post_2 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_5 <- felm(log(counseling) ~ c1_post_1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_n5 <- felm(log(counseling) ~ c1_post_n1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_10 <- felm(log(counseling) ~ c2_post_2 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_5 <- felm(log(counseling) ~ c2_post_1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_n5 <- felm(log(counseling) ~ c2_post_n1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_10 <- felm(log(counseling) ~ c6_post_2 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_5 <- felm(log(counseling) ~ c6_post_1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_n5 <- felm(log(counseling) ~ c6_post_n1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_10 <- felm(log(medication) ~ c1_post_2 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_5 <- felm(log(medication) ~ c1_post_1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_n5 <- felm(log(medication) ~ c1_post_n1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_10 <- felm(log(medication) ~ c2_post_2 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_5 <- felm(log(medication) ~ c2_post_1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_n5 <- felm(log(medication) ~ c2_post_n1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_10 <- felm(log(medication) ~ c6_post_2 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_5 <- felm(log(medication) ~ c6_post_1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_n5 <- felm(log(medication) ~ c6_post_n1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_10 <- felm(log(no_counseling) ~ c1_post_2 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_5 <- felm(log(no_counseling) ~ c1_post_1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c1_n5 <- felm(log(no_counseling) ~ c1_post_n1 + c1_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_10 <- felm(log(no_counseling) ~ c2_post_2 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_5 <- felm(log(no_counseling) ~ c2_post_1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c2_n5 <- felm(log(no_counseling) ~ c2_post_n1 + c2_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_10 <- felm(log(no_counseling) ~ c6_post_2 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_5 <- felm(log(no_counseling) ~ c6_post_1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
...
c6_n5 <- felm(log(no_counseling) ~ c6_post_n1 + c6_future + 
               initclaims_combined + 
               contclaims_combined + cases_per_100k_5day + 
               factor(e1_income_support) + factor(e2_debt_contract_relief) + 
                log(covid_norm+1) + log(lockdown_norm+1)
